...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5339394059:AAESap4VRPOsL37YyMvKwuvA8GPd4RInjr8")
    ...
    AUTH_USERS = set(str(x) for x in os.environ.get("AUTH_USERS", "822711564 1193977766 1495023343 1844303560 5181756679").split())
